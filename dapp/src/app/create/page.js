            ...
            <div className="container">
                <div className="ps-5">
                    <div className="row my-3">
                        <p className="lead">Preencha os campos abaixo para nos dizer o que precisa:</p>
                    </div>
                    <div className="col-6">
                    ...
                    <div className="col-6">
                        <div className="form-floating mb-3">
                            ...
                            <label htmlFor="goal">Meta em BNB (deixe em branco caso não queira receber a doação em cripto):</label>
                        </div>
                    </div>
                    <div className="row">
